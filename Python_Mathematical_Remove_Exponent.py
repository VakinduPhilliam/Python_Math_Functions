...
# If an application does not care about tracking significance, it is easy to remove the exponent and
# trailing zeroes, losing significance, but keeping the value unchanged:
